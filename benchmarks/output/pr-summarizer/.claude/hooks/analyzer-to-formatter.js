...
const INPUT = path.resolve('.graft/session/node_outputs/analyzer.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/analyzer_to_formatter.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Analyzer->Formatter | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
