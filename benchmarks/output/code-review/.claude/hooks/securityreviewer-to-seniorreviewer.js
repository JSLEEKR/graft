...
const INPUT = path.resolve('.graft/session/node_outputs/securityreviewer.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/securityreviewer_to_seniorreviewer.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge SecurityReviewer->SeniorReviewer | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
