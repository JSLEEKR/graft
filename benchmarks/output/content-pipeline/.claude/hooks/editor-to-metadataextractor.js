...
const INPUT = path.resolve('.graft/session/node_outputs/editor.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/editor_to_metadataextractor.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Editor->MetadataExtractor | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
