...
const INPUT = path.resolve('.graft/session/node_outputs/drafter.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/drafter_to_editor.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Drafter->Editor | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
