...
const INPUT = path.resolve('.graft/session/node_outputs/researcher.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/researcher_to_drafter.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Researcher->Drafter | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
