...
const OUTPUT = path.resolve('.graft/session/node_outputs/classifier_to_statanalyzer.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Classifier->StatAnalyzer | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
