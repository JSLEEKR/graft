...
const INPUT = path.resolve('.graft/session/node_outputs/classifier.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/classifier_to_trendanalyzer.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Classifier->TrendAnalyzer | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
