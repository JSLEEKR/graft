...
const INPUT = path.resolve('.graft/session/node_outputs/trendanalyzer.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/trendanalyzer_to_reportwriter.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge TrendAnalyzer->ReportWriter | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
