...
const INPUT = path.resolve('.graft/session/node_outputs/statanalyzer.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/statanalyzer_to_reportwriter.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge StatAnalyzer->ReportWriter | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
