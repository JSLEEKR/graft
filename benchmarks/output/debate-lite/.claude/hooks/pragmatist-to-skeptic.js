...
const OUTPUT = path.resolve('.graft/session/node_outputs/pragmatist_to_skeptic.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Pragmatist->Skeptic | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
