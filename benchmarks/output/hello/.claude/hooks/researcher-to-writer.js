...
const OUTPUT = path.resolve('.graft/session/node_outputs/researcher_to_writer.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Researcher->Writer | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
