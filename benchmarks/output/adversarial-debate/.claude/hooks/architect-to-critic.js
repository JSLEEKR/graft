...
const INPUT = path.resolve('.graft/session/node_outputs/architect.json');
const OUTPUT = path.resolve('.graft/session/node_outputs/architect_to_critic.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Architect->Critic | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
