...
const OUTPUT = path.resolve('.graft/session/node_outputs/pragmatist_to_critic.json');
...
fs.appendFileSync(TOKEN_LOG, `[${timestamp}] Edge Pragmatist->Critic | ${original}B -> ${transformed}B (${reduction}% reduction)\n`);
